# Faça um algoritmo que leia a nota de vários alunos de uma turma. O programa vai parar quando for digitada a nota 999. No final, mostre quantos alunos existem na turma e qual é a média de notas do grupo.
