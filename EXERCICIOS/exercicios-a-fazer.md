...
14) Fazer um algoritmo que calcula o preço à vista e o preço no cartão de crédito de uma
...
11. Cronômetro  
12. Timer regressivo  
13. Contador de cliques (com Tkinter)  
...
77. Bot de Telegram básico  
78. Monitoramento de site (verifica se está online)  
79. Web scraper de filmes/livros  
80. Rastreador de preços da Steam  
81. Agenda pessoal com calendário  
82. Sistema de login e cadastro com SQLite  
83. Gerenciador de senhas (tipo 1Password)  
84. Aplicativo de lista de compras  
85. Jogo de xadrez básico  
86. Sistema de boletim escolar  
87. Simulador de caixa eletrônico  
88. Bloco de notas com interface gráfica  
89. Gerador de certificados (PDF)  
90. Simulador de banco de dados simples  
91. Ferramenta de sorteio aleatório  
92. Chat em tempo real (socket)  
93. App de tarefas com interface gráfica  
94. Calculadora científica  
95. Painel de controle de tempo de estudo  
96. Site de portfólio (com Flask)  
97. Mini blog (Flask + SQLite)  
98. API REST com Flask  
...
1. Gerador de piadas aleatórias  
2. Conversor de idade para dias  
3. Sorteador de nomes  
4. Simulador de dado (4, 6, 20 lados)  
5. Contador de letras em uma palavra  
6. Gerador de cumprimentos personalizados  
7. Verificador de signo do zodíaco  
8. Calculadora de gorjeta  
9. Simulador de crescimento populacional  
10. Jogo "Maior ou Menor"  
11. Inversor de palavras  
12. Contador de vogais e consoantes  
13. Gerador de hashtags  
14. Verificador de palavras repetidas  
15. Transformador de emojis  
16. Verificador de ano bissexto  
17. Contador regressivo para aniversário  
18. Relógio digital no terminal  
19. Calculadora de tempo de vídeos  
20. Jogo "Adivinhe o animal"  
21. Quiz de capitais  
22. Jogo "Quente/Frio"  
23. Simulador de cassino simplificado  
24. Verificador de palíndromos  
25. Calculadora de área de formas  
26. Conversor de medidas (kg → lbs, km → milhas)  
27. Gerador de lista de compras  
28. Gerador de poema aleatório  
29. Criador de mensagens secretas  
30. Simulador de clima
...
5. **Contador de palavras em um texto**  
6. **Simulador de lançamento de moeda (Cara ou Coroa)**  
...
29. **Autômatos Celulares (Jogo da Vida de Conway)** – Regras de nascimento/morte.  
...
Remova todos os nomes de usuário de sua lista e certifique-se de que a mensagem carreta seja exibida.

5.10-Verificando nomes de usuários: Faça o seguinte para criar um programa que simule o modo como os sites garantem que todos tenham um nome de

usuário único. Crie uma lista chamada current_users com cinco ou mais nomes de usuários.

Crie outra lista chamada new users com cinco nomes de usuários. Garanta que um ou dois dos novos usuários também estejam na lista current_users.
...
5.11- Números ordinais: Números ordinais indicam sua posição em uma lista, por exemplo, 1st ou 2nd, em inglês. A maioria dos números ordinais nessa lingua termina com th, exceto 1, 2 e 3.
